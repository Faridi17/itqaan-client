...
const RegistrationForm = () => {
    ...
    const uploadRegistration = async (e) => {
        e.preventDefault()
        setLoading(true)
    ...
    return (
        <Layout>
            <div className='max-w-6xl mx-auto p-5 py-14 md:py-18 lg:py-24'>
                <div className='mb-4'>
                    <p className='text-2xl text-dark font-semibold opacity-90'>
                        Formulir PPDB Tahun 2024
                    </p>
                    <div className='border-t-4 mt-3 border-primary rounded-full opacity-70' />
                </div>
                <form onSubmit={uploadRegistration}>
                    <div>
                    ...
                    <div>
                        ...
                        <div className='w-full mb-4 lg:flex'>
                            <h1 className="lg:w-2/6 mt-3 text-base text-slate-700 opacity-95">
                                Pernyataan<span className='text-red-600 ml-0.5'>*</span>
                            </h1>
                            <div className="flex items-start mb-6 lg:w-4/6">
                                <div className="flex items-center h-5">
                                    <input type="checkbox" className="w-4 h-4 border border-blue-300 rounded bg-gray-50 focus:ring-3 focus:ring-blue-300" required />
                                </div>
                                <label className="ms-2 text-sm text-gray-600">
                                    Saya menyatakan dengan sesungguhnya bahwa isian data dalam formulir ini adalah benar. Apabila ternyata data tersebut tidak benar / palsu,
                                    maka saya bersedia menerima sanksi sesuai ketentuan yang berlaku di <span className='font-bold opacity-95'>SMPIT Al-Itqaan Palembang Daarussalam</span>
                                </label>
                            </div>
                        </div>
                    </div>
                ...
                <div className='mt-4'>
                    ...
                    <ol className='text-sm text-gray-600 list-decimal ml-4'>
                        ...
                        <li>
                            Cetak Formulir dengan kertas F4 sebagai bukti Pendaftaran
                        </li>
                        <li>
                            Konfirmasi Pendaftaran Dengan Mengirimkan Bukti Pembayaran ke <a href="https://wa.me/6283802890120" className='inline font-semibold' target='_blank'>WhatsApp : 6283802890120</a> Diikuti Nama Calon Siswa Dengan Format
                            [Nama Spasi Tanggal Daftar Spasi Telah Mengisi Formulir] Contoh: AHMAD DZAKI 15/1/2024 Telah Mengisi Formulir.
                            Jika dikemudian hari membatalkan Pendaftaran maka uang yang sudah dibayarkan tidak bisa ditarik kembali.
                        </li>
                    </ol>
                </div>
            </div>
